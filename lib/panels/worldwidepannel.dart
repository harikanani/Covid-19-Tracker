      ...
      child: GridView(
        ...
        children: <Widget>[
          StatusPanel(
            ...
            count: worldData==null ? 'Null' : worldData['cases'].toString(),
          ),
          StatusPanel(
            title: 'ACTIVE',
            panelColor: Colors.blue[100],
            textColor: Colors.blue[900],
            count: worldData==null ? 'Null' : worldData['active'].toString(),
          ),
          StatusPanel(
            title: 'RECOVERED',
            panelColor: Colors.green[100],
            textColor: Colors.green,
            count: worldData==null ? 'Null' : worldData['recovered'].toString(),
          ),
          StatusPanel(
            title: 'DEATHS',
            panelColor: Colors.grey[400],
            textColor: Colors.grey[900],
            count: worldData==null ? 'Null' : worldData['deaths'].toString(),
          ),
        ],
      ),
    );
