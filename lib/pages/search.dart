                  ...
                  Expanded(child: Container(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('DEATHS : ' + suggestionList[index]['deaths'].toString(), style: TextStyle(fontWeight: FontWeight.bold, color: Theme.of(context).brightness==Brightness.dark?[100]:Colors.grey[900])),
                      ],
                    ),
                  ))
                ],
